...
namespace Domore.Conf.Extensions {
    ...
    public static class ConfObject {
        private static TextSourceProvider SourceProvider => _SourceProvider ??= new TextSourceProvider();
        private static TextSourceProvider _SourceProvider;

        private static TextContentProvider ContentProvider => _ContentProvider ??= new TextContentProvider();
